...
module.exports = Class({
    ...
    add: function (data) {
        ...
        return this.model().then(function (model) {
            ...
            lastSql = {table: self.trueTableName, data: data, where: ''};
    ...
    delete: function () {
        ...
        return self.model().then(function (model) {
            ...
            lastSql = {table: self.trueTableName, data: '', where: where};
            var deferred = getDefer();
    ...
    update: function (data, ignoreRet) {
        ...
        return this.model().then(function (model) {
            ...
            lastSql = {table: self.trueTableName, data: data, where: self._options.where};
            var deferred = getDefer();
