...
module.exports = Class({
    ...
    delete: function () {
        ...
        return this._beforeDelete(self.parseWhere()).then(function (where) {
            ...
            return self._afterDelete(self.parseWhere());
        });
    },
    /**
     * 删除后续操作
    ...
    update: function (data, ignoreRet) {
        var self = this;
        return this._beforeUpdate(data,self.parseWhere()).then(function (data) {
            return {model:self.model(),data:data};
        }).then(function (res) {
            ...
            return self._afterUpdate(data,self.parseWhere());
        });
    },
    /**
     * 更新后置操作
    ...
    select: function () {
        ...
        return this.model().then(function (model) {
            ...
            return self._afterSelect(result, self.parseWhere());
        });
    },
    /**
     * 查询后置操作
